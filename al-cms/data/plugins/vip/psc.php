...
if($_POST['submit'])
{
		...
		if ($_POST['psc1']=="" && $_POST['v_name']=="" && $_POST['v_nachname']=="" && $_POST['v_email']=="" && $_POST['auswahl']=="")
		{
		echo "		
		<div id=vipall>
  		<div class=vipoben><h2>VIP-Bestellung-PSC</h2></div>
  		<div class=vipfmitte>
		...
		<div id=vipall>
  		<div class=vipoben><h2>VIP-Bestellung-PSC</h2></div>
  		<div class=vipfmitte>
		Sie haben keine PSC-Nummer angegeben.
		</div>
		</div>";	
		}
		...
		('". $vipbestellungsid ."', '". $vbaid ."' , '". $_POST['psc1'] ."')";
		...
		$vipbb="INSERT INTO vip_bezahlung (vbid, vbaid, b1) VALUES 
		('". $vipbestellungsid ."', '". $vbaid ."' , '". $_POST['psc2'] ."')";
		$b=mysql_query($vipbb) or die ("Fehler beim Eintragen! 2" . mysql_error());
		}
		// PSC 3
		if ( $_POST['psc3']=="")
		...
		{
		$vipbb="INSERT INTO vip_bezahlung (vbid, vbaid, b1) VALUES 
		('". $vipbestellungsid ."', '". $vbaid ."' , '". $_POST['psc3'] ."')";
		$b=mysql_query($vipbb) or die ("Fehler beim Eintragen! 2" . mysql_error());
		}
		// PSC 4
		if ( $_POST['psc4']=="")
		...
		{
		$vipbb="INSERT INTO vip_bezahlung (vbid, vbaid, b1) VALUES 
		('". $vipbestellungsid ."', '". $vbaid ."' , '". $_POST['psc4'] ."')";
		$b=mysql_query($vipbb) or die ("Fehler beim Eintragen! 2" . mysql_error());
		}
		// PSC 5
		if ( $_POST['psc5']=="")
		...
		{
		$vipbb="INSERT INTO vip_bezahlung (vbid, vbaid, b1) VALUES 
		('". $vipbestellungsid ."', '". $vbaid ."' , '". $_POST['psc5'] ."')";
		$b=mysql_query($vipbb) or die ("Fehler beim Eintragen! 2" . mysql_error());
		}
...
sp:
  ...
  echo '  
		...
		<td width="20%">
		<input type="text" name="psc1" size="40" maxlength="18" class="inputan"> <!-- PSC-Nummern sind aktuell nur maximal 16 Zeichen lang. -->
		</td>
		</tr>
		<tr>
		<td width="20%">
		...
		<td width="20%">
		<input type="text" name="psc2" size="40" maxlength="18" class="inputan"> <!-- PSC-Nummern sind aktuell nur maximal 16 Zeichen lang. -->
		</td>
		</tr>
		<tr>
		<td width="20%">
		...
		<td width="20%">
		<input type="text" name="psc3" size="40" maxlength="18" class="inputan"> <!-- PSC-Nummern sind aktuell nur maximal 16 Zeichen lang. -->
		</td>
		</tr>
		<tr>
		<td width="20%">
		...
		<td width="20%">
		<input type="text" name="psc4" size="40" maxlength="18" class="inputan"> <!-- PSC-Nummern sind aktuell nur maximal 16 Zeichen lang. -->
		</td>
		</tr>
		<tr>
		<td width="20%">
		...
		<td width="20%">
		<input type="text" name="psc5" size="40" maxlength="18" class="inputan"> <!-- PSC-Nummern sind aktuell nur maximal 16 Zeichen lang. -->
		</td>
		</tr>
		<tr>
		<td height=20px>
